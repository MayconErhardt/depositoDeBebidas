...
public class viewFuncionario extends javax.swing.JDialog {
     ...
     */
    ControleFuncionario contFuncionario;
    private Funcionario func;
    SimpleDateFormat formatar = new SimpleDateFormat("dd/MM/yyyy");
    private boolean status = false;
    private Funcionario funcionari;

    public viewFuncionario(java.awt.Frame parent, boolean modal, Funcionario funcionario) {
        super(parent, modal);
        initComponents();

        funcionari = funcionario;
        contFuncionario = new ControleFuncionario();
        listFuncionario.addAll(contFuncionario.semUsuario(funcionari.getFuncionarioId()));
    ...
    private void initComponents() {
        ...
        listFuncionario = observableList(new ArrayList<>());
        ...
        rSPanelGradiente2.setMinimumSize(new java.awt.Dimension(0, 0));
        ...
        labRua.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        labRua.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagem/icons/position.png"))); // NOI18N
        ...
        labCargo.setFont(new java.awt.Font("SansSerif", 0, 12)); // NOI18N
        labCargo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagem/icons/Especialidade (2).png"))); // NOI18N
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(10, 10, 10)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(labCPF, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(labRua, javax.swing.GroupLayout.PREFERRED_SIZE, 226, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(30, 30, 30)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(labBairro, javax.swing.GroupLayout.PREFERRED_SIZE, 188, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(laBCidade, javax.swing.GroupLayout.PREFERRED_SIZE, 246, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(labCargo, javax.swing.GroupLayout.PREFERRED_SIZE, 308, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addComponent(labRua)
                .addGap(18, 18, 18)
                .addComponent(labBairro, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(laBCidade, javax.swing.GroupLayout.PREFERRED_SIZE, 19, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        tabFuncionario.setColorFilasBackgound1(new java.awt.Color(250, 250, 250));
        tabFuncionario.setColorFilasBackgound2(new java.awt.Color(209, 209, 209));
        ...
        tabFuncionario.getTableHeader().setResizingAllowed(false);
        tabFuncionario.getTableHeader().setReorderingAllowed(false);

        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listFuncionario, tabFuncionario);
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${funcionarioNome}"));
        columnBinding.setColumnName("Nome");
        columnBinding.setColumnClass(String.class);
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${funcionarioTelefone}"));
        columnBinding.setColumnName("Telefone");
        columnBinding.setColumnClass(String.class);
        columnBinding.setEditable(false);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${funcionarioEmail}"));
        ...
        botNovo.setText("INSERIR NOVO FUNCIONÁRIO");
    ...
    private void tabFuncionarioMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabFuncionarioMouseClicked
        ...
        if (evt.getClickCount() > 1) {
            ...
            viewDadosFuncionario insAlte = new viewDadosFuncionario(null, true, funcionari, consulta, func);
            ...
            if (linha != -1) {
                ...
                func = listFuncionario.get(linha);
                labelNome.setText(func.getFuncionarioNome());
                labRua.setText(func.getFuncionarioRua() + ", Nº " + func.getFuncionarioNumeroRua());
                laBCidade.setText(func.getFuncionarioCidade() + ",  Estado: " + func.getFuncionarioEstado());
                labCargo.setText(func.getFuncionarioCargo());
                labBairro.setText(func.getFuncionarioBairo());
                labCPF.setText(func.getFuncionarioCPF());
                labDataNasc.setText(formatar.format(func.getFuncionarioDataNascimento()));
                labEmail.setText(func.getFuncionarioEmail());
                //  labEstado.setText(func.getFuncionarioEstado());
                //labNumRua.setText(String.valueOf(func.getFuncionarioNumeroRua()));
                labTelefone.setText(func.getFuncionarioTelefone());
            }
        }
        Funcionario buscaEu;
        buscaEu = contFuncionario.buscaEu(funcionari.getFuncionarioId());
        //  JOptionPane.showMessageDialog(null, buscaEu);
        if (buscaEu.getFuncionarioCargo().equals("GERENTE")) {
    ...
    private void botNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botNovoActionPerformed
        ...
        boolean x = false;
        viewDadosFuncionario dadosFun = new viewDadosFuncionario(null, true, funcionari, x, null);
    ...
    private void botAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botAlterarActionPerformed
        ...
        // tabFuncionario.setAltoHead(ALLBITS);
        int linha = -1;
        linha = tabFuncionario.getSelectedRow();
        if (linha != -1) {
            boolean x = true;
            func = listFuncionario.get(linha);
            viewDadosFuncionario alterar = new viewDadosFuncionario(null, true, funcionari, x, func);
    ...
    private void txtBuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarKeyReleased
        ...
        if (boxPesquisa.getSelectedItem().equals("NOME")) {
            listFuncionario.clear();
            listFuncionario.addAll(contFuncionario.listarPorNome(txtBuscar.getText(), funcionari.getFuncionarioId()));
        } else {
            listFuncionario.clear();
            listFuncionario.addAll(contFuncionario.listarPorCPF(txtBuscar.getText(), funcionari.getFuncionarioId()));
        }
    ...
    private void botExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botExcluirActionPerformed
        ...
        if (linhaExcluir != -1) {
            func = listFuncionario.get(linhaExcluir);
            ...
            if (op == JOptionPane.YES_OPTION) {
                ...
                try {
                    contFuncionario.excluir(func.getFuncionarioId());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                viewFuncionario dialog = new viewFuncionario(new javax.swing.JFrame(), true, null);
