...
public class BuscarProduto extends javax.swing.JDialog {
    ...
    public BuscarProduto(java.awt.Frame parent, boolean modal, boolean status) {
        super(parent, modal);
        initComponents();
        ...
        if (status == false) {
            botNovoProduto.setVisible(false);
            statusVerifica = false;
        } else {
            botNovoProduto.setVisible(true);
            statusVerifica = true;
        }
    ...
    private void initComponents() {
        ...
        botNovoProduto.setFont(new java.awt.Font("SansSerif", 1, 12)); // NOI18N
        botNovoProduto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagem/icons/novoProduto18px.png"))); // NOI18N
        botNovoProduto.setText("NOVO PRODUTO");
        ...
        rSPanelGradiente1Layout.setHorizontalGroup(
            ...
            .addGroup(rSPanelGradiente1Layout.createSequentialGroup()
                ...
                .addGap(68, 68, 68)
                .addComponent(botNovoProduto, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        rSPanelGradiente1Layout.setVerticalGroup(
            ...
            .addGroup(rSPanelGradiente1Layout.createSequentialGroup()
                ...
                .addGroup(rSPanelGradiente1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(botNovoProduto, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(2, 2, 2))
        );
...
//        }
    ...
    private void txtBuscarProdutoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtBuscarProdutoKeyReleased
        ...
        if (statusVerifica != true) {
            ...
            listaProduto.addAll(contPro.listarPorNome(txtBuscarProduto.getText()));
        }
        atualizarTabela();
//        while (modelo.getRowCount() > 0) {
//            // apaga a primeira linha
...
//
        if (linha != -1) {
            ...
            labValorProduto.setText(doubleString(p.getProdutoValorVenda()));
...
//            labRazao.setText(f.getFornecedorRazaoSicial());
    ...
    private void botNovoProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botNovoProdutoActionPerformed
        ...
        viewDadosProduto viewDadoProd = new viewDadosProduto(null, true, produtoBuscar);
        viewDadoProd.setVisible(true);
        listaProduto.addAll(contPro.listarTodos());
        atualizarTabela();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscarProduto dialog = new BuscarProduto(new javax.swing.JFrame(), true, true);
