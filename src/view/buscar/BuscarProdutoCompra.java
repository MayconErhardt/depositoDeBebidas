 ...
 * @author Maycon
 */
public class BuscarProdutoCompra extends javax.swing.JDialog {
    ...
    ArrayList<ItemCompra> itemCompraLista = new ArrayList<>();
    ...
    public BuscarProdutoCompra(java.awt.Frame parent, boolean modal, boolean status, ArrayList<ItemCompra> itemCompraNaCompra) {
        super(parent, modal);
        initComponents();
        ...
        if (itemCompraNaCompra.isEmpty()) {
            ...
            itemCompraLista = new ArrayList<>();
            //  listaProduto.clear();
            listaSemRepetido.clear();
            itemCompraLista.addAll(itemCompraNaCompra);
            ControleProduto contp = new ControleProduto();
            listaProduto.addAll(contp.listarTodos());

            verficarListas(itemCompraNaCompra, listaProduto);
        }
        atualizarTabela();
        darTamanhoAColuna();
    ...
    private void initComponents() {
        ...
        botNovoProduto.setFont(new java.awt.Font("SansSerif", 1, 14)); // NOI18N
    ...
    private void botLimparActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botLimparActionPerformed
        ...
        if (itemCompraLista.isEmpty()) {
            ...
            verficarListas(itemCompraLista, listaProduto);
        }
        atualizarTabela();
        // TODO add your handling code here:
...
//
    ...
    private void botNovoProdutoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botNovoProdutoActionPerformed
        ...
        listaProduto.clear();
        listaProduto.addAll(c.listarTodos());
        listaSemRepetido.clear();
        verficarListas(itemCompraLista, listaProduto);
        atualizarTabela();
        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarProdutoCompra.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                BuscarProdutoCompra dialog = new BuscarProdutoCompra(new javax.swing.JFrame(), true, true, null);
    ...
    public ArrayList verficarListas(ArrayList<ItemCompra> iTCompraLista, ArrayList<Produto> listaProduto) {

        if (!(listaProduto.size() == iTCompraLista.size())) {
            for (Produto produtoNoBanco : listaProduto) {
                if (iTCompraLista.stream().anyMatch(i -> i.getProdutoCod().getProdutoId() == (produtoNoBanco.getProdutoId()))) {
